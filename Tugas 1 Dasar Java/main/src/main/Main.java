    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (pilih == 1){
                ...
                System.out.print("Nama   : "); mhs.nama = inputBaru.nextLine();
                System.out.print("NIM    : "); mhs.nim = inputBaru.nextLine();
                System.out.print("Usia   : "); mhs.usia = inputBaru.nextInt();
                System.out.print("UTS    : "); mhs.uts = inputBaru.nextDouble();
                System.out.print("UAS    : "); mhs.uas = inputBaru.nextDouble();
            } else {
                System.out.println(" ");
            }
